...
def calculate_loss(output_1, mean_mean, stu_mean, log_stu_covariance, labels, input_stu_ids, kn_id, correctness_history, loss_batch):
    ...
    # writer1.add_scalar("loss_NLL", loss_pred.detach(), loss_batch)
    # writer2.add_scalar("loss_KL", loss_kl.detach(), loss_batch)
    # writer3.add_scalar("loss_ranking", loss_ranking.detach(), loss_batch)
...
if __name__ == '__main__':
    ...
    eps = params.eps
    # writer1 = SummaryWriter(log_dir="loss_pred")
    # writer2 = SummaryWriter(log_dir="loss_KL")
    # writer3 = SummaryWriter(log_dir="loss_ranking")
